...
use_for_force <- use_for_force_original %>%
  select(matches("Total_Less_lethal_force_2020", "ORI","Population","Police Department")) %>% 
  mutate(Total_Less_lethal_force_2020=if_else(is.na(Total_Less_lethal_force_2020),0,Total_Less_lethal_force_2020))
